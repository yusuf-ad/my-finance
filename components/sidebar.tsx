...
function Sidebar() {
  ...
  return (
    <div
      className={clsx(
        "sticky bottom-0 z-50 lg:inset-0 bg-dark lg:max-h-screen rounded-t-xl lg:rounded-r-xl lg:rounded-t-none lg:rounded-tr-xl pt-4 px-6 lg:px-0 lg:py-10 flex flex-col lg:h-auto transition-all duration-500",
